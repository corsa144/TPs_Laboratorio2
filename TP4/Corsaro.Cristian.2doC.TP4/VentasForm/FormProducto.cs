...
namespace FabricaForm
{
    public partial class FormProducto : Form
    {
        ...
        {
            if(fabrica.Productos.Count < this.fabrica.AlmacenDeProductos)
            {
                try
                {
                    if (this.cmbProducto.SelectedIndex == 0)
                    {
                        ...
                        {
                            MessageBox.Show($"Reintente. {ex.Message}");
                            return;
                        }
                        // Lectura
            ...
            {
                MessageBox.Show("No hay lugar en la fabrica");
                return;
            }
